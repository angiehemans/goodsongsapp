      ...
      <div style={{ maxWidth: contentMaxWidth, margin: '0 auto', padding: '2rem 1rem' }}>
        ...
        {layout.show_author && (
          <div style={{
            ...
            <ThemedShareButton postableType="post" postableId={post.id} bgColor={theme.background_color} fontColor={theme.font_color} bodyFont={theme.body_font} borderRadius={theme.border_radius} />
            <ThemedLikeButton
              postId={post.id}
