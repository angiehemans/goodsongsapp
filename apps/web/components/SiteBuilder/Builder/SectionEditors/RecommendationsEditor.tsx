...
import { RecommendationsContent, RecommendationsSettings, RecommendationsLayout, RecommendationsTitleAlign, RecommendationsGap } from '@/lib/site-builder/types';
...
const layoutOptions: LayoutOption<RecommendationsLayout>[] = [
  { value: 'grid', icon: <IconLayoutGrid size={18} />, label: 'Grid' },
  { value: 'stack', icon: <IconLayoutList size={18} />, label: 'Stack' },
];

const titleAlignOptions: LayoutOption<RecommendationsTitleAlign>[] = [
...
export function RecommendationsEditor({ index, settings }: RecommendationsEditorProps) {
  ...
  const handleSettingsChange = <K extends keyof RecommendationsSettings>(field: K, value: RecommendationsSettings[K]) => {
  ...
  return (
    <Stack gap={12}>
      ...
      <div className="builder-field-row">
        <div className="builder-field-row__label">Recommendations to show</div>
        <div className="builder-field-row__input">
          <NumberInput
      ...
      <div className="builder-field-row">
        ...
        <div className="builder-field-row__input">
          <Select
            ...
            onChange={(value) => handleSettingsChange('gap', value as RecommendationsGap)}
            data={[
