...
const SAMPLE_POST = {
  title: 'Why This Song Changed Everything For Me',
  author: 'Jamie Rivera',
  date: 'February 18, 2026',
  song: {
    name: 'Midnight Carousel',
    artist: 'The Pale Lanterns',
  },
  body: `<p>There are songs that you hear once and forget, and then there are songs that rearrange something inside you. "Midnight Carousel" by The Pale Lanterns is the latter. I first heard it on a late-night drive through the desert, the kind where the road stretches out endlessly and the stars feel close enough to touch.</p>
<p>The opening guitar line is deceptively simple — just a few notes that loop and shimmer like heat rising off asphalt. But then the bass comes in, low and heavy, and suddenly you're somewhere else entirely. The production on this track is immaculate. Every layer feels intentional, every silence earned.</p>
<blockquote><p>The best music doesn't just fill silence — it rearranges something inside you and puts it back slightly different than before.</p></blockquote>
<p>What really gets me is the bridge. The vocals pull back to almost a whisper, and there's this moment where everything drops out except a single synth pad and the sound of what I swear is a music box. It's haunting and beautiful and it makes me feel like I'm seven years old again, lying on the living room floor listening to my parents' records.</p>
<p>I've listened to this song probably 200 times now and I'm still finding new details. The way the drums shift from a straight four-on-the-floor to something more syncopated in the second verse. The subtle vocal harmonies that only appear once and never come back. It's the kind of songwriting that rewards patience.</p>
<p>If you haven't heard it yet, do yourself a favor. Put on some good headphones, turn the lights down, and just listen.</p>`,
...
export function SinglePostPreview({ theme, layout }: SinglePostPreviewProps) {
  ...
  const style: CSSProperties & Record<string, string> = {
    ...
    '--gs-profile-content-max-width': layout.max_width ? `${layout.max_width}px` : `${theme.content_max_width || 1200}px`,
      ...
      <div style={{ maxWidth: contentMaxWidth, margin: '0 auto', padding: '2rem 1rem' }}>
        ...
        {layout.show_featured_image && (
          <div style={{
            ...
            <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" style={{ color: 'var(--gs-profile-font)', opacity: 0.2 }}>
